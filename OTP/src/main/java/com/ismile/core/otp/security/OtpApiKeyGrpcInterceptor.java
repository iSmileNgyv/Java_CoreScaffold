package com.ismile.core.otp.security;
...
/**
 * Simple gRPC {@link ServerInterceptor} that enforces the presence of a shared API key
 * before allowing OTP operations to proceed.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class OtpApiKeyGrpcInterceptor implements ServerInterceptor {

    private static final Metadata.Key<String> API_KEY_HEADER =
            Metadata.Key.of("x-api-key", Metadata.ASCII_STRING_MARSHALLER);

    private final OtpSecurityProperties securityProperties;
